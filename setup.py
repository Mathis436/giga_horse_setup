...
sudo apt install nvidia-driver-535 unzip nvtop screen vim htop sysstat qemu-guest-agent nfs-common git python3-aionotify libgomp1 ocl-icd-libopencl1 rsync -y
...
echo "./cuda_plot_k32 -n -1 -C 8 -t /mnt/temp/ -2 /mnt/local/ -f b437465a764326e215d9c92e4394f219a920f28a651d916d65b0af1ac5710ad894a5a9f9552d89006eee68fda043a211 -c xch12c7n4z6jaxhtqt4j4l694mdzadm363nu0u6e58p6fy8mz4p0z9lst6rqem" >> cupl>
chmod 777 cuplot.sh
