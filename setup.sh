...
# sudo apt install nvidia-driver-535 unzip nvtop screen htop qemu-guest-agent nfs-common git python3-aionotify libgomp1 ocl-icd-libopencl1 rsync nano -y
sudo apt install unzip screen htop qemu-guest-agent nfs-common git python3-aionotify libgomp1 ocl-icd-libopencl1 rsync nano -y
git clone https://github.com/madMAx43v3r/chia-gigahorse.git
wget https://github.com/madMAx43v3r/chia-gigahorse/releases/download/v2.1.3.giga26/chia-gigahorse-farmer-2.1.3.giga26-x86_64.tar.gz
tar -xvf chia-gigahorse-farmer-2.1.3.giga26-x86_64.tar.gz
...
sudo chown william:william /mnt
chmod 777 cuplot.sh
